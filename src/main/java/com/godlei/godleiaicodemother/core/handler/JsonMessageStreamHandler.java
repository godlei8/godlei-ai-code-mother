package com.godlei.godleiaicodemother.core.handler;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.godlei.godleiaicodemother.ai.model.message.*;
import com.godlei.godleiaicodemother.ai.tools.BaseTool;
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.saveAiError(appId, loginUser.getId(), errorMessage);
                });
    }
